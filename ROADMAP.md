...
2. **Реальная WhatsApp-ссылка:** заменить `https://chat.whatsapp.com/PLACEHOLDER_QOSPERNE`
   в `index.html` (3 места) + `script.js` (константа `WHATSAPP_URL`) + QR (`QR_code.png` пересоздать).
